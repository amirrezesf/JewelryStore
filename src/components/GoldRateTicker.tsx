...
export const GoldRateTicker: React.FC<GoldRateTickerProps> = ({
  ...
  return (
    <div className="bg-[#F4F1EA] border-y border-[#E2DDD3] py-3.5 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-3 sm:gap-4">
        ...
        <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 sm:gap-5">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-[#57534E] font-medium">تابلوی برخط نرخ طلا:</span>
          </div>

          {/* 18 Karat Rate */}
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white border border-[#E2DDD3] shadow-xs">
            <span className="text-xs text-[#78716C]">طلای ۱۸ عیار (۷۵۰):</span>
          ...
          {/* 24 Karat Rate */}
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white border border-[#E2DDD3] shadow-xs">
            <span className="text-xs text-[#78716C]">طلای ۲۴ عیار (۹۹۹):</span>
