...
export const AdminPanel: React.FC<AdminPanelProps> = ({
  ...
  const [prodForm, setProdForm] = useState<Partial<Product>>({
    ...
    craftFeePercent: 12,
    description: '',
    images: ['/ZarinJewelry/assets/images/1605100804763-247f67b3557e.jpg'],
    inStock: true,
    stockCount: 5,
    isFeatured: false,
    isNew: true,
  ...
  const handleSaveProduct = (e: React.FormEvent) => {
    ...
    if (editingProduct) {
      ...
      const newP: Product = {
        ...
        images: prodForm.images && prodForm.images.length > 0 ? prodForm.images : ['/ZarinJewelry/assets/images/1605100804763-247f67b3557e.jpg'],
